...
// when using paginated APIs in GitLab.
...
// primitives.
//
// For example, `&MergeRequestCreateOptions{Draft: Ptr(true)}`.
...
// This is useful to translate between Golang-style "unset is zero" and GitLab API
